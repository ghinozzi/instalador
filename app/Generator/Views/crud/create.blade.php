                            ...
                            <div class="card-body py-3 pb-5">
                                <form action="{{route('__Tabela__.store')}}" method="post">
                                    ...
                                    <div class="form-group pt-2">
                                        ...
                                        <input type="text" name="NmGrupo" id="NmGrupo" class="form-control form-control-solid" placeholder="Nome do grupo">
                                    </div>
                                    <div class="form-group pt-5 pb-5">
                                        <input class="form-check-input" type="checkbox" id="FlAdmin" name="FlAdmin" value="1">
