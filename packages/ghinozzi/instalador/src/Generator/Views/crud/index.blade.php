                                        ...
                                        @foreach($data as $d)
                                            <tr>
                                                ...
                                                <td class='table-actions'>
                                                    <a href="{{route('__Tabela__.edit',array('__NomeVariavel__'=>$d->__PrimaryKey__))}}" class="btn btn-light">
                                                    ...
                                                    <a href="{{route('__Tabela__.destroy',array('__NomeVariavel__'=>$d->__PrimaryKey__))}}" class="btn btn-light form-delete" data-id='{{$d->id}}' onclick="event.preventDefault();" >
