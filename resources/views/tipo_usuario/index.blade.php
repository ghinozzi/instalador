                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5 pb-5">
                                <div class="space-between">
                                    <h3 class="card-title align-items-start flex-column">tipo_usuario</h3>
                                    <a href="{{route('tipo_usuario.create')}}" class="btn btn-sm btn-primary"> Adicionar tipo_usuario</a>
                                </div>
                            </div>
                            <hr>
                            <!--end::Header-->
                                        ...
                                        @foreach($data as $d)
                                            <tr>
                                                ...
                                                <td class='table-actions'>
                                                    <a href="{{route('tipo_usuario.edit',array('tipo_usuario'=>$d->id))}}" class="btn btn-light">
                                                    ...
                                                    <a href="{{route('tipo_usuario.destroy',array('tipo_usuario'=>$d->id))}}" class="btn btn-light form-delete" data-id='{{$d->id}}' onclick="event.preventDefault();" >
