                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5 pb-5">
                                <div class="space-between">
                                    <h3 class="card-title align-items-start flex-column">usuario</h3>
                                    <a href="{{route('usuario.create')}}" class="btn btn-sm btn-primary"> Adicionar usuario</a>
                                </div>
                            </div>
                            <hr>
                            <!--end::Header-->
...
<td>{{$d->senha}}</td>
                                                ...
                                                <td class='table-actions'>
                                                    <a href="{{route('usuario.edit',array('usuario'=>$d->id))}}" class="btn btn-light">
                                                    ...
                                                    <a href="{{route('usuario.destroy',array('usuario'=>$d->id))}}" class="btn btn-light form-delete" data-id='{{$d->id}}' onclick="event.preventDefault();" >
